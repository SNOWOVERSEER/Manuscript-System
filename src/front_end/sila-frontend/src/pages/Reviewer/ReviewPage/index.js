...
const ReviewPage = () => {
    ...
    const handleSubmit = () => {
        console.log("Submitting content:", editorComments, authorComments, recommendation, willingToReview);
    ...
    return (
        <div className="reviewpage" style={{ padding: '20px' }}>
            <div style={{ textAlign: 'left', marginBottom: '20px' }}>
                ...
                <div><b>STUDIES IN LANGUAGE ASSESSMENT: The international journal of the Association for Language Testing and Assessment of Australia and New Zealand.</b></div>
            </div>
            ...
            <div style={{ margin: '20px 0' }}>
                ...
                <p>Studies in Language Assessment (SiLA) is the international peer-reviewed research journal of the Association for Language Testing and Assessment of Australia and New Zealand (<a href="https://www.altaanz.org/" target="_blank">ALTAANZ</a>). It previously appeared under the title Papers in Language Testing and Assessment (PLTA). The journal is an online, open-access publication that welcomes contributions from both new and experienced researchers in the form of full research articles, research reports and discussion papers, on topics in the field of language assessment. It also publishes commissioned book and test reviews. Currently, there are at least one regular issue and one theme-based special issue each year. SiLA is included in the Web of Science Emerging Sources Citation Index (ESCI).</p>
                <p>SiLA is available exclusively online at <a href="https://www.altaanz.org/" target="_blank">ALTAANZ</a> and the <a href="https://arts.unimelb.edu.au/language-testing-research-centre/research/publications" target="_blank">Language Testing Research Centre</a>.</p>
            </div>

            <div style={{ margin: '20px 0' }}>
                <b>Reviewing Guidelines</b>
                <p>Reviewers are asked to make a recommendation on a paper using one of four categories (accept, accept with revisions, revise and resubmit, reject).</p>
                <ul>
                ...
                <p>If you have any questions about the review process, please email the Editorial Assistant, Annemiek Huisman, at <a href="mailto:sila.editors@gmail.com">sila.editors@gmail.com</a>.</p>
            </div>

            <div style={{ margin: '20px 0' }}>
                <b>Recommendation (Select One):</b>
                <Radio.Group onChange={handleRecommendationChange} value={recommendation}>
                    <Radio value="accept">Accept – this article is suitable for publication.</Radio>
                    <Radio value="minor_revisions">Accept with minor revisions – this article is suitable for publication in its present form, provided that minor corrections or revisions are made as specified in the comments below.</Radio>
                    <Radio value="revise_resubmit">Revise & resubmit – this article is potentially suitable for publication, but requires considerable revision as specified in the comments below.</Radio>
                    <Radio value="reject">Reject – this article is not recommended for publication.</Radio>
                </Radio.Group>
            </div>
            ...
            <Card title="Comments to the Editors (confidential)" style={{ paddingBottom: '50px'}}>
                <ReactQuill
            ...
            <Card title="Comments to the Author(s)" style={{ paddingBottom: '50px'}}>
                <ReactQuill
